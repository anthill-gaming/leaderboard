...
SECRET_KEY = 'im7-6akc#^e4m!kcvl_tb+bx9-7b5v=4h%dfedfzh-n%x(r#&amp;1'
...
SQLALCHEMY_DATABASE_URI = 'postgres://anthill_leaderboard@/anthill_leaderboard'

LOCATION = 'http://localhost:9621'
BROKER = 'amqp://guest:guest@localhost:5672'

# ROUTES_CONF = 'leaderboard.routes'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'anthill.server': {
            ...
            'filename': os.path.join(LOGGING_ROOT_DIR, 'leaderboard.log'),
            'formatter': 'anthill.server',
...
GRAPHENE = {
    'SCHEMA': 'leaderboard.api.v1.public.schema',
    'MIDDLEWARE': ()
}
